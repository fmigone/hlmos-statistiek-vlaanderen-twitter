...
x = collect_tweets(api.search, keyword=[":) OR :-) OR :D OR :-D OR : )"], location=None, location_granularity = 'country', lang="nl", result_type="mixed", limit=5000)
x.to_csv("tweets_positive.csv", encoding='utf-8', index=False, sep=";")
x.to_pickle("tweets_positive.pck", compression=None)

x = collect_tweets(api.search, keyword=":( OR : ( OR :'(", location=None, location_granularity = 'country', lang="nl", result_type="mixed", limit=5000)
